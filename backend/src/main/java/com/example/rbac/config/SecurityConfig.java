        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/shipping/area-rates/**").hasAnyAuthority("SHIPPING_VIEW", "SHIPPING_MANAGE")
                        .requestMatchers(HttpMethod.POST, "/api/v1/shipping/area-rates/**").hasAuthority("SHIPPING_MANAGE")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/shipping/area-rates/**").hasAuthority("SHIPPING_MANAGE")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/shipping/area-rates/**").hasAuthority("SHIPPING_MANAGE")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/shipping/area-rates/**").hasAuthority("SHIPPING_MANAGE")
